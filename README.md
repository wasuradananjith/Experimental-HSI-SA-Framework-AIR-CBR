...
*   [`user-study-1-code`](https://github.com/YOUR-GITHUB-USERNAME/experimental-hsi-sa-framework/tree/user-study-1-code) - Contains the code, CoppeliaSim environments, and full setup guide for **User Study 1** (Single-target search task with distributed, moving, and spreading hazard profiles).
